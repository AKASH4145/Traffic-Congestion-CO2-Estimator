...
# Load YOLOv3
weight_path=r'C:\Users\akash\OneDrive\Desktop\OpenCV Projects\Traffic Congestion & CO2 Estimator\Yolo\yolov3.weights'
config_path=r'C:\Users\akash\OneDrive\Desktop\OpenCV Projects\Traffic Congestion & CO2 Estimator\Yolo\yolov3.cfg'
net = cv2.dnn.readNet(weight_path,config_path)

# Load class names
with open(r"C:\Users\akash\OneDrive\Desktop\OpenCV Projects\Traffic Congestion & CO2 Estimator\Yolo\coco.names", "r") as f:
...
cap = cv2.VideoCapture(r'C:\Users\akash\OneDrive\Desktop\OpenCV Projects\Traffic Congestion & CO2 Estimator\Sample videos\traffic1.mp4')
